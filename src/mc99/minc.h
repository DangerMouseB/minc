...
#ifndef SRC_MC99_MINC_H
#define SRC_MC99_MINC_H
...
int fitsWithin(btypeid_t a, btypeid_t b) {
...
btypeid_t BTIntersect(btypeid_t a, btypeid_t b) {
    if ((a & 0x00000080) == 0 && (b == B_EXTERN)) return a | B_EXTERN;
    nyi("BTIntersect");
    return 0;
}

btypeid_t minus(btypeid_t a, btypeid_t b) {
...
// memory managers
Buckets all_strings, nodes, kbuckets;
